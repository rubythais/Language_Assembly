...
main:
	...
	addi $2 $0 4 # -> Tamanho X
	addi $3 $0 20 # -> Tamanho Y
	addi $4 $0 148 # -> Posicao X
	addi $5 $0 125 # -> Posicao Y
	jal Sunset_Draw
	
	addi $2 $0 50 # -> Tamanho X
	addi $3 $0 16 # -> Tamanho Y
	addi $4 $0 152 # -> Posicao X
	addi $5 $0 129 # -> Posicao Y
	jal Sunset_Draw
	
	addi $2 $0 4 # -> Tamanho X
	addi $3 $0 12 # -> Tamanho Y
	addi $4 $0 202 # -> Posicao X
	addi $5 $0 133 # -> Posicao Y
	jal Sunset_Draw
	
	addi $2 $0 4 # -> Tamanho X
	addi $3 $0 8 # -> Tamanho Y
	addi $4 $0 206 # -> Posicao X
	addi $5 $0 137 # -> Posicao Y
	jal Sunset_Draw
	
	addi $2 $0 16 # -> Tamanho X
	addi $3 $0 10 # -> Tamanho Y
	addi $4 $0 210 # -> Posicao X
	addi $5 $0 135 # -> Posicao Y
	jal Sunset_Draw
	
	addi $2 $0 30 # -> Tamanho X
	addi $3 $0 7 # -> Tamanho Y
	addi $4 $0 226 # -> Posicao X
	addi $5 $0 138 # -> Posicao Y
	jal Sunset_Draw
